...
function Le(s, n, t) {
  s.__dragging_events || (s.addEventListener("dragover", (a) => {
    ...
    var b;
    a.stopPropagation(), a.preventDefault(), s.classList.remove(n.value);
    const d = (b = a.dataTransfer) == null ? void 0 : b.items, g = [], A = async (O) => {
      const D = [];
...
(function(s, n) {
  (function(t, a) {
    ...
    var t = 1e3, a = 6e4, d = 36e5, g = "millisecond", A = "second", M = "minute", b = "hour", O = "day", D = "week", v = "month", y = "quarter", L = "year", P = "date", te = "Invalid Date", oe = /^(\d{4})[-/]?(\d{1,2})?[-/]?(\d{0,2})[Tt\s]*(\d{1,2})?:?(\d{1,2})?:?(\d{1,2})?[.:]?(\d+)?$/, U = /\[([^\]]+)]|Y{1,4}|M{1,4}|D{1,2}|d{1,4}|H{1,2}|h{1,2}|a|A|m{1,2}|s{1,2}|Z{1,2}|SSS/g, ae = { name: "en", weekdays: "Sunday_Monday_Tuesday_Wednesday_Thursday_Friday_Saturday".split("_"), months: "January_February_March_April_May_June_July_August_September_October_November_December".split("_"), ordinal: function(c) {
      ...
      return { M: v, y: L, w: D, d: O, D: P, h: b, m: M, s: A, ms: g, Q: y }[c] || String(c || "").toLowerCase().replace(/s$/, "");
    }, u: function(c) {
      return c === void 0;
    } }, J = "en", G = {};
    G[J] = ae;
      ...
      return o.parse = function(r) {
        this.$d = function(u) {
          ...
          if (typeof i == "string" && !/Z$/i.test(i)) {
            var p = i.match(oe);
            if (p) {
              var $ = p[2] - 1 || 0, S = (p[7] || "0").substring(0, 3);
              return f ? new Date(Date.UTC(p[1], $, p[3] || 1, p[4] || 0, p[5] || 0, p[6] || 0, S)) : new Date(p[1], $, p[3] || 1, p[4] || 0, p[5] || 0, p[6] || 0, S);
            }
          }
          return new Date(i);
        }(r), this.init();
        ...
        }, k = this.$W, R = this.$M, T = this.$D, e = "set" + (this.$u ? "UTC" : "");
        switch (p) {
          case L:
            return f ? $(1, 0) : $(31, 11);
          case v:
            return f ? $(1, R) : $(0, R + 1);
          case D:
            var l = this.$locale().weekStart || 0, h = (k < l ? k + 7 : k) - l;
            return $(f ? T - h : T + (6 - h), R);
          case O:
          case P:
            return S(e + "Hours", 0);
          case b:
            return S(e + "Minutes", 1);
          case M:
            return S(e + "Seconds", 2);
          case A:
            return S(e + "Milliseconds", 3);
          default:
            return this.clone();
        }
      }, o.endOf = function(r) {
        ...
        var i, f = w.p(r), p = "set" + (this.$u ? "UTC" : ""), $ = (i = {}, i[O] = p + "Date", i[P] = p + "Date", i[v] = p + "Month", i[L] = p + "FullYear", i[b] = p + "Hours", i[M] = p + "Minutes", i[A] = p + "Seconds", i[g] = p + "Milliseconds", i)[f], S = f === O ? this.$D + (u - this.$W) : u;
        if (f === v || f === L) {
          var k = this.clone().set(P, 1);
          k.$d[$](S), k.init(), this.$d = k.set(P, Math.min(this.$D, k.daysInMonth())).$d;
        } else $ && this.$d[$](S);
        ...
        if (p === O) return $(1);
        if (p === D) return $(7);
        var S = (i = {}, i[M] = a, i[b] = d, i[A] = t, i)[p] || 1, k = this.$d.getTime() + r * S;
        return w.w(k, this);
        ...
        var f = r || "YYYY-MM-DDTHH:mm:ssZ", p = w.z(this), $ = this.$H, S = this.$m, k = this.$M, R = i.weekdays, T = i.months, e = i.meridiem, l = function(m, x, _, q) {
        ...
        var f, p = this, $ = w.p(u), S = I(r), k = (S.utcOffset() - this.utcOffset()) * a, R = this - S, T = function() {
          return w.m(p, S);
        };
        switch ($) {
          case L:
    ...
    return I.prototype = ne, [["$ms", g], ["$s", A], ["$m", M], ["$H", b], ["$W", O], ["$M", v], ["$y", L], ["$D", P]].forEach(function(c) {
      ne[c[1]] = function(o) {
...
function Te(s, n, t = {}) {
  const a = C(t.id ?? "vue-multi-uploader-" + se()), d = C(t.accept ?? ""), g = C(t.maxFiles), A = C(t.maxConcurrent ?? 2), M = C(t.maxItemSize), b = C(t.disabled ?? !1), O = C(t.readonly ?? !1), D = C(n), v = B(() => C(t.dropzone).value), y = C(t.onDragClass ?? "h-ondrag"), L = C(t.autoStart ?? !0), P = C(t.inputName ?? "file"), te = C(t.headers ?? {}), oe = C(t.data ?? {});
  let U = C(s);
  U.value = U.value.map(
  ...
  function I(e) {
    ...
    if (!e.file)
      return e;
    if (ne(e.file), M.value != null && e.file.size > M.value) {
      const m = new ke(
  ...
  function ne(e) {
    const l = k.value, h = e.name.split(".").pop();
    if (l.length) {
      let E = !1;
      if (l.forEach((m) => {
  ...
  const $ = B(() => (g.value == null || U.value.length < Number(g.value)) && !R.value), S = B(() => U.value.filter((l) => l.uploadState === z.UPLOADING).length > 0), k = B(() => (Array.isArray(d.value) ? d.value : d.value.split(",")).map((e) => e.trim()).filter((e) => e.length > 0).map((e) => e.indexOf("/") === -1 && e[0] === "." ? e.substr(1) : e)), R = B(() => b.value || O.value);
  ee(U, (e) => {
    e.map((l) => {
      l.key = l.key || se();
    }), N("change", U);
...
const xe = { class: "vue-drag-uploader__wrapper vue-drag-uploader__items" }, Ke = /* @__PURE__ */ he({
  ...
  setup(s, { expose: n, emit: t }) {
    const a = s, d = t, g = $e(s, "modelValue"), A = de(g.value);
    ee(g, () => {
      A.value = g.value;
    }, { deep: !0 });
    const M = Me("el");
    a.options.dropzone = a.options.dropzone ?? M;
    const b = a.instance ?? Te(A, a.uploadUrl ?? "", a.options), {
      isReadonly: O,
      items: D
    } = b;
    ee(D, () => {
  ...
  setup(s, { emit: n }) {
    ...
    const M = B(() => t.item.file ? t.item.file.name : t.item.title ? t.item.title : t.item.url.split("/").pop()), b = B(() => O(
      ...
      W(v.$slots, "it", { item: v.item }, () => {
        ...
        return [
          ...
          b.value ? re("", !0) : (H(), j("div", Fe, [
            ...
            F("div", He, fe(M.value), 1)
          ])),
          F("div", Ye, [
            v.isReadonly ? re("", !0) : (H(), j("span", {
              key: 0,
              class: "preview-img__remove-icon",
              onClick: y[0] || (y[0] = ve((P) => A(), ["prevent", "stop"]))
            }, [
          ...
          d.value === Y(z).ERROR ? (H(), j("div", {
            ...
            F("span", Ge, fe((L = v.item.error) == null ? void 0 : L.message), 1)
          ])) : re("", !0)
        ];
      })
    ], 4));
